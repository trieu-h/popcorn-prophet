...
<main>
    <header class="text-white flex justify-between items-center max-md:items-start max-md:gap-3 border-b border-dark-gray p-5 max-md:flex-col">
    ...
    <div id="overlay" class="fixed top-0 left-0 h-full w-full pointer-events-none">
      <Button 
        class="absolute rounded-4xl right-10 bottom-10 pointer-events-auto transition-opacity ease-in-out 
               opacity-{!analytics_state.show_back_to_top_button ? "0" : "100"}"
